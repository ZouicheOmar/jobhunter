import { CandidsPage, CompanyPage } from "@/types";
...
const PaginationElipsis = () => (
  <li>
    {" "}
    <span className="border inline-block text-center w-[2em] px-2">
      {" "}
      ...{" "}
    </span>{" "}
  </li>
...
export const Pagination = ({ page }: { page: CandidsPage | CompanyPage }) => {
