...
const Label = () => (
  <p className=" text-sm sm:text-lg md:text-xl text-neutral-700">Top Cities</p>
);
...
const MainStat = ({ list }: { list: CandidPerCity[] }) => (
  <div className="self-end">
    <p className="text-lg sm:text-xl md:text-3xl text-end font-medium capitalize ">
      {list[0].city.name}
    </p>
...
export const StatTopCities = ({
  ...
  <div className="grow bg-white flex flex-col rounded-xl p-4   min-w-1/4">
    <Label />
